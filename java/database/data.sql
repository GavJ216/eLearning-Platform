...
INSERT INTO lesson (course_id,lesson_name,lesson_description, lesson_completion) VALUES (1,'Multi-Factor Authentication','Enable multi-factor authentication (MFA) to ensure that the only person who has access to your account is you. Use it for email, banking, social media, and any other service that requires logging in.', false);
INSERT INTO lesson (course_id,lesson_name,lesson_description, lesson_completion) VALUES (2,'Wi-Fi Safety','Practice safe web surfing wherever you are by checking for the “green lock” or padlock icon in your browser bar—this signifies a secure connection. When you find yourself out in the great “wild Wi-Fi West,” avoid free internet access with no encryption.', false);
INSERT INTO lesson (course_id,lesson_name,lesson_description, lesson_completion) VALUES (1,'App Security','Check your app permissions and use the “rule of least privilege” to delete what you don’t need or no longer use.. Learn to just say “no” to privilege requests that don’t make sense. Only download apps from trusted sources.', true);
INSERT INTO lesson (course_id,lesson_name,lesson_description, lesson_completion) VALUES (2,'Oversharing and Geotagging','What many people don’t realize is that these seemingly random details are all criminals need to know to target you, your loved ones, and even your physical belongings—online and in the real world. Avoid posting names, phone numbers, addresses, school and work locations, and other sensitive information', false);
